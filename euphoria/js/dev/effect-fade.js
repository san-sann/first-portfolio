...
function formRating() {
	...
	function formRatingInit(rating, ratingSize, ratingIndex) {
		...
		for (let index = 0; index < ratingSize; index++) {
			...
			ratingItems += isInteractive ? `
				<label class="rating__item">
					<input class="rating__input" type="radio" name="${groupName}" value="${index + 1}" aria-label="Rate ${index + 1} star${index === 0 ? "" : "s"}">
				</label>` : `
...
//#endregion
export { createElementIfNotDefined as a, elementChildren as c, elementParents as d, isObject as f, Navigation as i, elementIndex as l, setInnerHTML as m, A11y as n, Keyboard as o, makeElementsArray as p, classesToSelector as r, Swiper as s, EffectFade as t, elementOuterSize as u };
