...
function initTestimonialsSliders() {
	if (!document.querySelector("[data-fls-testimonials-slider]")) return;
...
window.addEventListener("load", initTestimonialsSliders);
//#endregion
...
function menuInit() {
	const menuIcon = document.querySelector("[data-fls-menu]");
	document.addEventListener("click", function(e) {
		if (bodyLockStatus && e.target.closest("[data-fls-menu]")) {
			bodyLockToggle();
			document.documentElement.toggleAttribute("data-fls-menu-open");
		} else if (e.target.closest("[data-fls-menu-backdrop]")) closeMenu();
	});
